<?php
/**
* CUSTOMIZED LIST TEMPLATE FOR MESTC THEME
* 
...
<div id="tribe-events-content" class="upcoming">
	...
	<?php else :?>
		...
		?>
		<?php if(tribe_is_day()): ?>
			<?php printf( __('No events scheduled for <strong>%s</strong>. Please try another day.', 'tribe-events-calendar'), date_i18n('F d, Y', strtotime(get_query_var('evenliate')))); ?>
		<?php endif; ?>
